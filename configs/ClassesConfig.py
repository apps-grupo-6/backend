...
get_user_upcoming_classes_code_map = {
    "0200": ("ok", 200),
    "0500": ("the request could not be processed", 500)
}
...
update_class_code_map = {
    ...
    "0412": ("scheduled_at cannot be in the past", 400),
...
add_participant_code_map = {
    "0201": ("participant added to class", 201),
    "0404": ("invalid class_id", 404),
    "0405": ("the requested user is a participant in this class already", 400),
...
cancel_participant_code_map = {
    ...
    "0406": ("the requested user has a status that cannot be changed to 'CANCELLED'", 400),
...
confirm_participant_code_map = {
    ...
    "0404": ("invalid class_id", 404),
    "0405": ("the requested user is not a participant in this class", 404),
    "0406": ("the requested user has a status that cannot be changed to 'CONFIRMED'", 400),
    "0500": ("the request could not be processed", 500),
    "0501": ("the request could not be processed", 500),
    "0502": ("the request could not be processed", 500),
    "0503": ("the request could not be processed", 500)
...
get_user_classes_history_code_map = {
    "0200": ("ok", 200),
    "0400": ("bad request", 400),
    "0410": ("invalid since date", 400),
    "0411": ("invalid until date", 400),
    "0412": ("the requested since date can not be later than until date", 400),
    "0500": ("the request could not be processed", 500)
}
...
check_in_participant_code_map = {
    "0200": ("ok", 200),
    "0404": ("invalid class_id", 404),
    "0405": ("the requested user is not a participant in this class", 404),
    "0410": ("the requested user cannot check in to this class because it has already finished or cancelled", 400),
    "0411": ("the requested user has a status that cannot be changed to 'CHECKED IN'", 400),
    "0500": ("the request could not be processed", 500),
    "0501": ("the request could not be processed", 500),
    "0502": ("the request could not be processed", 500)
}